...
public class DetailsAdapter extends RecyclerView.Adapter<DetailsAdapter.MyViewHolder>
{
    ...
    public DetailsAdapter(Context context, JSONArray jsonArray) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.api_item_details_layout, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int listPosition) {
        ...
        try
        {
            ...
            Picasso.get()
                    .load(String.valueOf(jsonArray.get(listPosition)))
                    .into(backPicImv);
